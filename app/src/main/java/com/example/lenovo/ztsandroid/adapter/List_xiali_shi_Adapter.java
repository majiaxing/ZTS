...
public class List_xiali_shi_Adapter extends BaseAdapter {

    private Context context;
    public ArrayList<Diq_Shi_Bean.DataBean> channels;

    public List_xiali_shi_Adapter(Context context, ArrayList<Diq_Shi_Bean.DataBean> channels) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Diq_Shi_Bean.DataBean liveBean = channels.get(i);
        viewHolder.textView.setText(liveBean.getShi_name());
