...
public class List_Danc_Adapter extends BaseAdapter{


    private Context context;
    public ArrayList<Dc_Xq_Bean.DataBean> channels;

    public List_Danc_Adapter(Context context, ArrayList<Dc_Xq_Bean.DataBean> channels) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Dc_Xq_Bean.DataBean liveBean = channels.get(i);
        viewHolder.textView.setText(liveBean.getWord());
