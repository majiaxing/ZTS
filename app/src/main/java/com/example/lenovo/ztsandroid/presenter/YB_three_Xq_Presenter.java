...
public class YB_three_Xq_Presenter implements YB_XiangQ_Cotract.Presenter {

    private CSModel ybModel;
    private YB_XiangQ_Cotract.View View;


    public YB_three_Xq_Presenter(YB_XiangQ_Cotract.View loginView) {
         View = loginView;
    ...
    public void SetUrl(String ybid, String flag,String shiliType) {
        ...
        ybModel.postYinB_XQ_three(ybid, flag ,shiliType, new MyNetWorkCallback<YB_XQ_three_Bean>() {
            @Override
            public void onSuccess(YB_XQ_three_Bean yb_xq_one_bean) {
                View.getManagerTh(yb_xq_one_bean);
            }
