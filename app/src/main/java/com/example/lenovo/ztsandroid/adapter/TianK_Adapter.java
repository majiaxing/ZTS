...
public class TianK_Adapter extends BaseAdapter {

    private Context context;
    public ArrayList<TingL_XQ_xz_Bean.DataBean> channels;
    public TianK_Adapter(Context context, ArrayList<TingL_XQ_xz_Bean.DataBean> channels) {
