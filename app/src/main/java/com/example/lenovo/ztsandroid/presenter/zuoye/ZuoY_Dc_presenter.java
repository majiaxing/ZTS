...
public class ZuoY_Dc_presenter implements ZuoY_Dc_Cotract.Presenter {


    private ZuoY_Dc_Cotract.View view;
    private CSModel csModel;

    public ZuoY_Dc_presenter(ZuoY_Dc_Cotract.View view) {
        this.view = view;
    ...
    public void SetUrl(String stuid, String hwid, String flag, String listen_type, String hw_type, String hw_content, String avgScore) {
        ...
        csModel.postZuoY_DC(stuid, hwid, flag, listen_type, hw_type, hw_content, avgScore, new MyNetWorkCallback<ZuoY_dc_Bean>() {
            @Override
            public void onSuccess(ZuoY_dc_Bean zuoYDcBean) {
