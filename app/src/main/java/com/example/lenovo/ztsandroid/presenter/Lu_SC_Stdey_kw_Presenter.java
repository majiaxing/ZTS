...
public class Lu_SC_Stdey_kw_Presenter implements ZhiL_Yuyin_Cotract.Presenter{
    ...
    public Lu_SC_Stdey_kw_Presenter(ZhiL_Yuyin_Cotract.View view) {
        this.view = view;
    ...
    public void SetU(String stuid, String word_id, String learn_video, String learn_score, String type) {
        ...
        csModel.postSC_Lu_Stdeykw(stuid, word_id, learn_video, learn_score, type, new MyNetWorkCallback<Stdey_Bean>() {
            @Override
