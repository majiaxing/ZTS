...
public class Read_nr_Adapter extends BaseAdapter {

    private Context context;
    public ArrayList<Read_erj_Bean.DataBean> channels;

    public Read_nr_Adapter(Context context, ArrayList<Read_erj_Bean.DataBean> channels) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Read_erj_Bean.DataBean liveBean = channels.get(i);
        viewHolder.textView.setText(liveBean.getRead_title());
