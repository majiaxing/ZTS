...
public class List_xiali_qu_Adapter extends BaseAdapter {

    private Context context;
    public ArrayList<Diq_Qu_Bean.DataBean> channels;

    public List_xiali_qu_Adapter(Context context, ArrayList<Diq_Qu_Bean.DataBean> channels) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Diq_Qu_Bean.DataBean liveBean = channels.get(i);
        viewHolder.textView.setText(liveBean.getQu_name());
